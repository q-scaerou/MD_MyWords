...
CREATE TABLE NOTEBOOK (
	...
	id_group INT NOT NULL CONSTRAINT FK_NOTEBOOK_app_group FOREIGN KEY (id_group) REFERENCES APP_GROUP(id)
);
...
CREATE TABLE NOTE (
	...
	previousNote INT NULL CONSTRAINT FK_NOTE_previousNote FOREIGN KEY (previousNote) REFERENCES NOTE(id) ON DELETE SET NULL
);
